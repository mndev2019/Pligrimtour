...
const KashmirDetail = () => {
    const faqdata = [
        {
            ...
            answer: "The best time to visit Kashmir is from March to October. During these months, the valley is in full bloom and the weather is pleasant. For snow lovers, December to February is ideal for experiencing snowfall and winter sports."
        },
        {
            question: "What are the must-visit attractions in Kashmir?",
            answer: "Some of the top attractions include Srinagar’s Dal Lake and Mughal Gardens, Gulmarg for skiing, Pahalgam for scenic beauty, and Sonmarg for snow-clad mountains and glaciers."
        },
    ...
    return (
        <>
            <InnerBanner title="Kashmir Tour Package" />
                    ...
                    <div className='lg:col-span-8 col-span-1 lg:order-1 order-2'>
                        <div className="w-full">
                            ...
                            <p className='text-gray-700 my-5'>
                                Known as “Paradise on Earth,” Kashmir is a breathtaking destination nestled in the lap of the Himalayas. From the serene Dal Lake and colorful tulip gardens in Srinagar to the snow-covered peaks of Gulmarg and the lush valleys of Pahalgam, Kashmir offers a perfect blend of natural beauty, adventure, and cultural heritage. Our Kashmir Tour Package ensures a luxurious and memorable experience for all kinds of travelers.
                            </p>
